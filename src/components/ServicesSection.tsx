...
const services: Service[] = [
  ...
  },
  {
    ...
    description: "Creating beautiful, responsive user interfaces with optimized performance and accessibility.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: "Seamless integration with third-party APIs and services to enhance application functionality.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: "Reviewing existing codebases to improve quality, performance, and maintainability.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div 
              key={service.id}
              className="bg-card border border-border/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal"
              style={{ 
        ...
        <div className="mt-16 text-center p-8 bg-secondary/30 rounded-lg reveal">
          <h3 className="text-2xl font-bold mb-4">Need Custom Development Services?</h3>
          <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
            I'm always open to discussing new projects, creative ideas or opportunities to be part of your vision.
          </p>
          <a href="#contact" className="px-6 py-3 bg-primary text-white rounded-full font-medium hover:bg-primary/90 transition-colors inline-block">
            Get In Touch
          </a>
        </div>
      </div>
